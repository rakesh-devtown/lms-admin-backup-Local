...
const ArchiveStudentModal = ({ isVisible, onClose, handleArchiveStudent }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="p-10 relative">
                <div className="flex-1 bg-white mt-12 rounded-lg w-[50vh] h-[20vh]">
                    <div className="flex flex-col space-y-2 ">
                        <span className="text-sm flex text-gray-700 font-poppins mt-5 px-2 items-center mb-4">
                            <svg className='w-5 h-5 mr-2 mb-3 ml-3' viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            Are you sure you want to archive this course from the student?
                        </span>
                        <div className='px-5 pt-4 flex justify-between items-center'>
                            ...
                            <button className='bg-[#1890FF] text-white px-16 py-1 rounded-md font-poppins text-sm border-2' onClick={handleArchiveStudent}>Yes</button>
                        </div>
                    </div>
                </div>
            </div>
